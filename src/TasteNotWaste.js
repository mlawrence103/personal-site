      ...
      <div id="taste-not-waste">
        ...
        <div className="project-page-description">
          <p>
            ...
            suggesting recipes using the relevant ingredients. (Built with a
            team of four for the Grace Hopper Program)
          </p>
        </div>
          ...
          <div id="tnw-techstack-responsibilities">
            <div id="tnw-responsibilities">
              ...
              <ul>
                ...
                <li>
                  Set up pre-populated form in React Native to allow users to
